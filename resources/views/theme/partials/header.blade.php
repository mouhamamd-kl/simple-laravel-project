     ...
     <div class="main_menu">
         <nav class="navbar navbar-expand-lg navbar-light">
             <div class="container box_1620">
                 ...
                 <a class="navbar-brand logo_h" href="{{ route('theme.index') }}"><img src="{{ asset('asset') }}/img/logo.png"
                         alt=""></a>
                     ...
                     <ul class="nav navbar-nav menu_nav justify-content-center">
                         ...
                         <li class="nav-item  submenu dropdown @yield('category-active')">
                             ...
                             <ul class="dropdown-menu">
                                 ...
                                 <li class="nav-item"><a class="nav-link" href="{route('theme.category')}">Bussiness</a>
                                 </li>
